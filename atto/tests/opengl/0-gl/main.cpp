...
int main(int argc, char const *argv[])
{
    ...
    /*
     * Create viewer drawable.
     */
    Rop rop(
        "../images/monarch_512.png",
        "../images/baboon_512.png",
        1000,
        1000,
        2048,
        2048);
